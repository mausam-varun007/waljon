         ...
         <div class="row">
            <div class="col-md-12">
               <div class="product-slider owl-carousel ftco-animate">
                  ...
                  <div class="item">
                     <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="<?php echo base_url();?>assets/images/product-2.jpg" alt="Colorlib Template"></a>
                        <div class="text pt-3 px-3">
                           <h3><a href="#">Young Woman Wearing Dress</a></h3>
                           <div class="d-flex">
                              <div class="pricing">
                  ...
                  <div class="item">
                     <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="<?php echo base_url();?>assets/images/product-3.jpg" alt="Colorlib Template"></a>
                        <div class="text pt-3 px-3">
                           <h3><a href="#">Young Woman Wearing Dress</a></h3>
                           <div class="d-flex">
                              <div class="pricing">
                  ...
                  <div class="item">
                     <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="<?php echo base_url();?>assets/images/product-4.jpg" alt="Colorlib Template"></a>
                        <div class="text pt-3 px-3">
                           <h3><a href="#">Young Woman Wearing Dress</a></h3>
                           <div class="d-flex">
                              <div class="pricing">
                  ...
                  <div class="item">
                     <div class="product">
                        <a href="#" class="img-prod"><img src="<?php echo base_url();?>assets/images/product-5.jpg" alt="Colorlib Template">
                           <span class="status">30%</span>
                        </a>
                        <div class="text pt-3 px-3">
                           <h3><a href="#">Young Woman Wearing Dress</a></h3>
                  ...
                  <div class="item">
                     <div class="product">
                        <a href="#" class="img-prod"><img src="<?php echo base_url();?>assets/images/product-6.jpg" alt="Colorlib Template"></a>
                        <div class="text pt-3 px-3">
                           <h3><a href="#">Young Woman Wearing Dress</a></h3>
                           <div class="d-flex">
                              <div class="pricing">
      ...
      <div class="container-fluid">
         <div class="row">
            <div class="col-sm col-md-6 col-lg ftco-animate">
               <div class="product">
                  <a href="#" class="img-prod"><img class="img-fluid" src="<?php echo base_url();?>assets/images/product-1.jpg" alt="Colorlib Template"></a>
